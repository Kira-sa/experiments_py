""" 
TODO: Написать "обманывающий" сервер времени
...
def parse_args():
    ...
    parser.add_argument('-d', '--delay', type=int, default=20.0, help='Set delay')
    parser.add_argument('-p', '--port', type=int, nargs=1, default=123, help='Listen port')
